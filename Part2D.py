...
for i in range(len(batch_size)):
    ...
    data3d.set_xlabel('theta0')
    data3d.set_ylabel('theta1')
    data3d.set_zlabel('theta2')
    
    title_p = "Movement of theta at varying batch size (batch size :"+str(batch_size[i])+")"
    data3d.set_title(title_p)
    data3d.scatter3D(xdata, ydata, zdata)
    
    plt.savefig('output/Ques2(D)_'+str(batch_size[i])+'.png')
